...
export default async function EditProductPage({
  ...
  // CJ synced products (have supplierProductId but no Printify-style ID) are read-only
  // from the storefront side, but all products are editable in the admin panel.
  // Only redirect if somehow we end up here from a non-admin context.
