    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[400px] p-8">
        <DialogHeader className="text-center sm:text-center">
          ...
          <DialogDescription>
            Choose your preferred way to access your portal.
          </DialogDescription>
        </DialogHeader>
        ...
        {isSuccess ? (
          <div className="text-center py-6">
            ...
            <p className="text-sm text-muted-foreground">
              We've sent a magic link to <span className="text-foreground font-bold">{email}</span>. Please check your inbox.
            </p>
            <Button 
              variant="ghost" 
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-muted-foreground">Or magic link</span>
              </div>
            </div>

            <form onSubmit={handleMagicLink} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="modal-email" className="text-xs uppercase font-bold tracking-wider text-muted-foreground">Email Address</Label>
                <Input
                  id="modal-email"
                  type="email"
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 rounded-xl accent-gradient text-white font-bold"
              >
