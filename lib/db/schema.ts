...
export const workflowExecutions = pgTable("workflow_execution", {
  id: uuid("id").defaultRandom().primaryKey(),
  userWorkflowId: uuid("userWorkflowId")
    .notNull()
...
export const userWorkflowRelations = relations(
  userWorkflows,
  ({ one, many }) => ({
    user: one(users, {
...
export const workflowSchedulerRelations = relations(
  workflows,
  ({ one, many }) => ({
    user: one(users, {
...
export const workflowRunSchedulerRelations = relations(
  workflowRuns,
  ({ one }) => ({
